                                 ...
                                 //, NVActivityIndicatorViewable
{
    ...
    override func viewDidLoad() {
        ...
        makeButton.setTitle("Create Live Photo", for: .normal)
        makeButton.titleLabel?.font = UIFont(name: "Copperplate", size: 32)
        ...
        trimmerView.mainColor = #colorLiteral(red: 0.1531849205, green: 0.6393200755, blue: 0.4440253973, alpha: 1)
...
//    }
    ...
    @objc func play(_ sender: Any) {
        ...
        if !player.isPlaying {
            ...
            DispatchQueue.main.async {
                   self.playButton.setImage(UIImage(named: "playpause.fill"), for: .normal)
            }
    ...
    private func addVideoPlayer(with assetUrl: URL, playerView: UIView) {
        ...
        trimmerView.asset = AVAsset(url: assetUrl)
    ...
    override func viewDidAppear(_ animated: Bool) {
        DispatchQueue.main.async {
            ...
            if !self.isPhotoAssetSelected{
                ...
                guard self.selectionType != nil else { return }
...
//    }
    ...
    private func playVideoAndSetupSlider(){
        ...
        guard self.selectedAsset != nil else { return }
...
extension SwiftMessages {
    ...
    class func showToast(_ message: String, type: Theme = .warning, buttonTitle: String? = nil) {
        ...
        view.backgroundView.backgroundColor = #colorLiteral(red: 0, green: 0, blue: 0, alpha: 1)
